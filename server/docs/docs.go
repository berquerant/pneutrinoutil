        ...
        "/proc": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "number",
                        "description": "[0, 100]%, default: 0 (before NEUTRINO v3)",
                        "name": "enhanceBreathiness",
                        "in": "formData"
                    },
                    {
                        "type": "number",
                        "description": "default: 1.0 (before NEUTRINO v3)",
                        "name": "formantShift",
                        "in": "formData"
                    },
                    {
                        "type": "integer",
                        "description": "[2, 3, 4], default: 2 (before NEUTRINO v3)",
                        "name": "inference",
                        "in": "formData"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "(NEUTRINO v3)",
                        "name": "supportModel",
                        "in": "formData"
                    },
                    {
                        "type": "integer",
                        "description": "default: 0 (NEUTRINO v3)",
                        "name": "transpose",
                        "in": "formData"
                    },
                    {
                        "type": "number",
                        "description": "default: 0 (before NEUTRINO v3)",
                        "name": "pitchShiftNsf",
                        "in": "formData"
                    },
                    {
