...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [enhanceBreathiness] [0, 100]%, default: 0
         * @param {number} [formantShift] default: 1.0
         * @param {number} [inference] [2, 3, 4], default: 2
         * @param {string} [model] default: MERROW
         * @param {number} [pitchShiftNsf] default: 0
         * @param {number} [pitchShiftWorld] default: 0
         * @param {number} [smoothFormant] [0, 100]%, default: 0
         * @param {number} [smoothPitch] [0, 100]%, default: 0
         * @param {number} [styleShift] default: 0
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        procPost: async (score: File, enhanceBreathiness?: number, formantShift?: number, inference?: number, model?: string, pitchShiftNsf?: number, pitchShiftWorld?: number, smoothFormant?: number, smoothPitch?: number, styleShift?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async procPost(score: File, enhanceBreathiness?: number, formantShift?: number, inference?: number, model?: string, pitchShiftNsf?: number, pitchShiftWorld?: number, smoothFormant?: number, smoothPitch?: number, styleShift?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HandlerSuccessResponseString>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.procPost(score, enhanceBreathiness, formantShift, inference, model, pitchShiftNsf, pitchShiftWorld, smoothFormant, smoothPitch, styleShift, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        procPost(score: File, enhanceBreathiness?: number, formantShift?: number, inference?: number, model?: string, pitchShiftNsf?: number, pitchShiftWorld?: number, smoothFormant?: number, smoothPitch?: number, styleShift?: number, options?: RawAxiosRequestConfig): AxiosPromise<HandlerSuccessResponseString> {
...
export class DefaultApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public procPost(score: File, enhanceBreathiness?: number, formantShift?: number, inference?: number, model?: string, pitchShiftNsf?: number, pitchShiftWorld?: number, smoothFormant?: number, smoothPitch?: number, styleShift?: number, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).procPost(score, enhanceBreathiness, formantShift, inference, model, pitchShiftNsf, pitchShiftWorld, smoothFormant, smoothPitch, styleShift, options).then((request) => request(this.axios, this.basePath));
    }
