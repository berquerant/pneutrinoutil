...
let supportModel: string; //support singer library (optional) (default to undefined)
let transpose: number; //default: 0 (optional) (default to undefined)
...
| **supportModel** | [**string**] | support singer library | (optional) defaults to undefined|
| **transpose** | [**number**] | default: 0 | (optional) defaults to undefined|
